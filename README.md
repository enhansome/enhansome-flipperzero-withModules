...
## [This repo is an improved fork of the OG Awesome Flipper Collection by djsime1!](https://github.com/djsime1/awesome-flipperzero) ⭐ 24,289 | 🐛 17 | 📅 2024-09-27
...
* [`UberGuidoZ Playground` Large collection of files, documentation, and dumps of all kinds.](https://github.com/UberGuidoZ/Flipper) ⭐ 17,532 | 🐛 8 | 🌐 C | 📅 2026-07-28
* [`Flipper BadUSB Payloads` Collection of payloads formatted to work on the Flipper Zero.](https://github.com/I-Am-Jakoby/Flipper-Zero-BadUSB) ⭐ 7,081 | 🐛 66 | 🌐 PowerShell | 📅 2024-06-15
* [`FlipperAmiibo` Bank vault of Amiibos to Flipper's format.](https://github.com/Gioman101/FlipperAmiibo) ⭐ 3,625 | 🐛 10 | 🌐 Python | 📅 2024-08-15
* [`Flipper-IRDB` Many IR dumps for various appliances.](https://github.com/logickworkshop/Flipper-IRDB) ⭐ 2,553 | 🐛 1 | 📅 2026-04-12
...
* [`FalsePhilosophers Flipper BadUSB` Flipper zero community ducky payload repo.](https://github.com/FalsePhilosopher/badusb) ⭐ 1,987 | 🐛 0 | 🌐 PowerShell | 📅 2026-09-01
...
* [`NullSec Flipper Zero Suite` Comprehensive payload collection with 430+ files including BadUSB scripts, SubGHz captures, NFC tools, IR databases, and GPIO utilities for penetration testing.](https://github.com/bad-antics/nullsec-flipper-suite) ⭐ 73 | 🐛 2 | 🌐 Python | 📅 2026-03-11
...
* [`SD Load Applications` Prebuilt applications (FAP) for popular firmware options.](https://github.com/UberGuidoZ/Flipper/tree/main/Applications) ⭐ 17,532 | 🐛 8 | 🌐 C | 📅 2026-07-28
...
* [`Flipp Pomodoro` Pomodoro Timer Tool for productivity.](https://github.com/Th3Un1q3/flipp_pomodoro) ⭐ 210 | 🐛 4 | 🌐 C | 📅 2026-09-16
...
* [`Unleashed` Unlocked firmware with rolling codes support & community plugins, stable tweaks, and games.](https://github.com/DarkFlippers/unleashed-firmware) ⭐ 22,269 | 🐛 28 | 🌐 C | 📅 2026-09-16
* [`RogueMaster` Unleashed + Official FW fork with assorted community plugins, tweaks, & games.](https://github.com/RogueMaster/flipperzero-firmware-wPlugins) ⭐ 6,362 | 🐛 0 | 🌐 C | 📅 2026-09-16
...
* [`UberGuidoZ Graphics` Brief description and links to resources, including PYX host.](https://github.com/UberGuidoZ/Flipper/tree/main/Graphics) ⭐ 17,532 | 🐛 8 | 🌐 C | 📅 2026-07-28
...
* [`H4XV Gif2FlipperAnimation Converter` Converts gifs to Flipper Animations](https://github.com/H4XV/flipper-animation-generator) ⭐ 27 | 🐛 1 | 🌐 Python | 📅 2024-02-23
...
* [`Marauder for Wifi Dev Board` See Flipper.bin in Releases by JustCallMeKoko.](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,377 | 🐛 328 | 🌐 C++ | 📅 2026-09-16
...
* [`PromptZero` Natural-language operator for the Flipper Zero (and ESP32 Marauder) — generate, deploy, and run payloads from a single sentence; CLI / web / MCP server modes.](https://github.com/xunholy/promptzero) ⭐ 229 | 🐛 0 | 🌐 Go | 📅 2026-08-17
...
* [`FZ Firmware Comparisons` Comparison of custom firmwares listed in this repo.](https://github.com/djsime1/awesome-flipperzero/blob/main/Firmwares.md) ⭐ 24,289 | 🐛 17 | 📅 2024-09-27
* [`Add-on Modules GPIO Pinouts` ESP32, ESP8266, ESP32-CAM, ESP32-WROOM, NRF24.](https://github.com/UberGuidoZ/Flipper/tree/main/GPIO) ⭐ 17,532 | 🐛 8 | 🌐 C | 📅 2026-07-28
* [`Flipper Zero Dimensions` Basic info on screen and case dimensions.](https://github.com/UberGuidoZ/Flipper/tree/main/FlipperZero_Dimensions) ⭐ 17,532 | 🐛 8 | 🌐 C | 📅 2026-07-28
* [`ESP32 Marauder on WiFi dev board` Portable WiFi/Bluetooth pentesting.](https://github.com/justcallmekoko/ESP32Marauder/wiki/flipper-zero) ⭐ 12,377 | 🐛 328 | 🌐 C++ | 📅 2026-09-16
